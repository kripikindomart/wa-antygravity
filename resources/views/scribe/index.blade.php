    ...
    <div id="toc">
                ...
                <li class="tocify-item level-1" data-unique="contacts">
                    <a href="#contacts">Contacts</a>
                                ...
                                <a href="#contacts-POSTapi-contacts">Create a new contact</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="contacts-GETapi-contacts--id-">
                                <a href="#contacts-GETapi-contacts--id-">Get contact details</a>
                            </li>
                                ...
                                <a href="#contacts-DELETEapi-contacts--id-">Delete a contact</a>
                            </li>
                                                                        </ul>
                            </ul>
                ...
                <li class="tocify-item level-1" data-unique="devices">
                    <a href="#devices">Devices</a>
                                ...
                                <a href="#devices-GETapi-devices">List all devices</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="devices-POSTapi-devices">
                                <a href="#devices-POSTapi-devices">Create a new device</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="devices-GETapi-devices--id-">
                                <a href="#devices-GETapi-devices--id-">Get device details</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="devices-DELETEapi-devices--id-">
                                <a href="#devices-DELETEapi-devices--id-">Delete a device</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="devices-GETapi-devices--id--qr">
                                <a href="#devices-GETapi-devices--id--qr">Get QR code for device</a>
                            </li>
                                                                        </ul>
                            </ul>
                ...
                <li class="tocify-item level-1" data-unique="endpoints">
                    <a href="#endpoints">Endpoints</a>
                                    ...
                                    <ul id="tocify-subheader-endpoints" class="tocify-subheader">
                                                    <li class="tocify-item level-2" data-unique="endpoints-POSTapi-webhook-whatsapp">
                                <a href="#endpoints-POSTapi-webhook-whatsapp">Handle incoming webhooks from Node.js WhatsApp service</a>
                            </li>
                                                                        </ul>
                            </ul>
                ...
                <li class="tocify-item level-1" data-unique="messages">
                    <a href="#messages">Messages</a>
                                    ...
                                    <ul id="tocify-subheader-messages" class="tocify-subheader">
                                                    <li class="tocify-item level-2" data-unique="messages-GETapi-messages">
                                <a href="#messages-GETapi-messages">List messages</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="messages-POSTapi-messages-send">
                                <a href="#messages-POSTapi-messages-send">Send a message</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="messages-POSTapi-messages-send-bulk">
                                <a href="#messages-POSTapi-messages-send-bulk">Send bulk messages</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="messages-GETapi-messages--id-">
                                <a href="#messages-GETapi-messages--id-">Get message status</a>
                            </li>
                                                                        </ul>
                            </ul>
            </div>
...
<p>Get a list of all contacts for the authenticated user.</p>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost/api/contacts?search=John&amp;group_id=1&amp;per_page=20" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<i>optional</i> &nbsp;
 &nbsp;
    ...
    <br>
<p>Search by name or phone. Example: <code>John</code></p>
            </div>
                                    <div style="padding-left: 28px; clear: unset;">
...
<i>optional</i> &nbsp;
 &nbsp;
               ...
               step="any"               name="group_id"                data-endpoint="GETapi-contacts"
               value="1"
               data-component="query">
    <br>
...
<i>optional</i> &nbsp;
 &nbsp;
               ...
               data-component="query">
    <br>
<p>Number of items per page (default: 50). Example: <code>20</code></p>
            </div>
                </form>

                    <h2 id="contacts-POSTapi-contacts">Create a new contact</h2>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
               ...
               data-component="body">
    <br>
<p>The contact's name. Example: <code>John Doe</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="phone_number"                data-endpoint="POSTapi-contacts"
               value="+628123456789"
               data-component="body">
    <br>
<p>The phone number (international format). Example: <code>+628123456789</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<i>optional</i> &nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Email address (optional). Example: <code>john@example.com</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>contact_group_id</code></b>&nbsp;&nbsp;
<small>integer</small>&nbsp;
<i>optional</i> &nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="contact_group_id"                data-endpoint="POSTapi-contacts"
               value="1"
               data-component="body">
    <br>
<p>Group ID (optional). Example: <code>1</code></p>
        </div>
        </form>

                    <h2 id="contacts-GETapi-contacts--id-">Get contact details</h2>
...
<small>integer</small>&nbsp;
 ...
 &nbsp;
               ...
               data-component="url">
    <br>
<p>The contact ID. Example: <code>1</code></p>
            </div>
                    </form>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="phone_number"                data-endpoint="PUTapi-contacts--id-"
               value="+628123456789"
               data-component="body">
    <br>
<p>The phone number. Example: <code>+628123456789</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>email</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="contact_group_id"                data-endpoint="PUTapi-contacts--id-"
               value=""
               data-component="body">
    <br>
<p>The <code>id</code> of an existing record in the contact_groups table.</p>
        </div>
        </form>

                    <h2 id="contacts-DELETEapi-contacts--id-">Delete a contact</h2>
...
<p>The contact ID. Example: <code>1</code></p>
    ...
    <p>APIs for managing WhatsApp devices</p>

                                <h2 id="devices-GETapi-devices">List all devices</h2>

<p>
<small class="badge badge-darkred">requires authentication</small>
</p>

<p>Get a list of all WhatsApp devices for the authenticated user.</p>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="devices-POSTapi-devices">Create a new device</h2>

<p>
<small class="badge badge-darkred">requires authentication</small>
</p>

<p>Create a new WhatsApp device. After creation, use the QR endpoint to get the QR code for connecting.</p>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
               ...
               data-component="body">
    <br>
<p>The name/label for this device. Example: <code>Customer Support</code></p>
        </div>
        </form>

                    <h2 id="devices-GETapi-devices--id-">Get device details</h2>

<p>
<small class="badge badge-darkred">requires authentication</small>
</p>

<p>Get details of a specific device.</p>
...
<small>integer</small>&nbsp;
 ...
 &nbsp;
               ...
               data-component="url">
    <br>
<p>The device ID. Example: <code>1</code></p>
            </div>
                    </form>

                    <h2 id="devices-DELETEapi-devices--id-">Delete a device</h2>

<p>
<small class="badge badge-darkred">requires authentication</small>
</p>

<p>Disconnect and delete a WhatsApp device.</p>
...
<p>The device ID. Example: <code>1</code></p>
                    ...
                    <h2 id="devices-GETapi-devices--id--qr">Get QR code for device</h2>

<p>
<small class="badge badge-darkred">requires authentication</small>
</p>

<p>Initialize a WhatsApp session and get the QR code for scanning.</p>

<span id="example-requests-GETapi-devices--id--qr">
<blockquote>Example request:</blockquote>


<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost/api/devices/1/qr" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://localhost/api/devices/1/qr"
);
...
<span id="example-responses-GETapi-devices--id--qr">
            <blockquote>
            <p>Example response (200):</p>
        </blockquote>
                <pre>
...
<span id="execution-results-GETapi-devices--id--qr" hidden>
    <blockquote>Received response<span
                id="execution-response-status-GETapi-devices--id--qr"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-GETapi-devices--id--qr"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-GETapi-devices--id--qr" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-GETapi-devices--id--qr">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-GETapi-devices--id--qr" data-method="GET"
      data-path="api/devices/{id}/qr"
      data-authed="1"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('GETapi-devices--id--qr', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-GETapi-devices--id--qr"
                    onclick="tryItOut('GETapi-devices--id--qr');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-devices--id--qr"
                    onclick="cancelTryOut('GETapi-devices--id--qr');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-GETapi-devices--id--qr"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-green">GET</small>
            <b><code>api/devices/{id}/qr</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Content-Type</code></b>&nbsp;&nbsp;
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="GETapi-devices--id--qr"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="GETapi-devices--id--qr"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>integer</small>&nbsp;
 ...
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="id"                data-endpoint="GETapi-devices--id--qr"
               value="1"
               data-component="url">
    <br>
<p>The device ID. Example: <code>1</code></p>
                ...
                <h1 id="endpoints">Endpoints</h1>
                                ...
                                <h2 id="endpoints-POSTapi-webhook-whatsapp">Handle incoming webhooks from Node.js WhatsApp service</h2>
...
<span id="example-requests-POSTapi-webhook-whatsapp">
<blockquote>Example request:</blockquote>


<div class="bash-example">
    <pre><code class="language-bash">curl --request POST \
    "http://localhost/api/webhook/whatsapp" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<span id="example-responses-POSTapi-webhook-whatsapp">
</span>
<span id="execution-results-POSTapi-webhook-whatsapp" hidden>
    <blockquote>Received response<span
                id="execution-response-status-POSTapi-webhook-whatsapp"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-POSTapi-webhook-whatsapp"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-POSTapi-webhook-whatsapp" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-POSTapi-webhook-whatsapp">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-POSTapi-webhook-whatsapp" data-method="POST"
      data-path="api/webhook/whatsapp"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('POSTapi-webhook-whatsapp', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-POSTapi-webhook-whatsapp"
                    onclick="tryItOut('POSTapi-webhook-whatsapp');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-POSTapi-webhook-whatsapp"
                    onclick="cancelTryOut('POSTapi-webhook-whatsapp');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-POSTapi-webhook-whatsapp"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-black">POST</small>
            <b><code>api/webhook/whatsapp</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Content-Type</code></b>&nbsp;&nbsp;
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="POSTapi-webhook-whatsapp"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="POSTapi-webhook-whatsapp"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
    ...
    <p>APIs for sending and managing WhatsApp messages</p>

                                <h2 id="messages-GETapi-messages">List messages</h2>

<p>
<small class="badge badge-darkred">requires authentication</small>
</p>

<p>Get a list of sent messages for the authenticated user.</p>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost/api/messages?device_id=1&amp;status=sent&amp;per_page=20" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="device_id"                data-endpoint="GETapi-messages"
               value="1"
               data-component="query">
    <br>
<p>Filter by device ID. Example: <code>1</code></p>
            </div>
                                    <div style="padding-left: 28px; clear: unset;">
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="status"                data-endpoint="GETapi-messages"
               value="sent"
               data-component="query">
    <br>
<p>Filter by status (pending, sent, failed). Example: <code>sent</code></p>
            </div>
                                    <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>per_page</code></b>&nbsp;&nbsp;
<small>integer</small>&nbsp;
<i>optional</i> &nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="per_page"                data-endpoint="GETapi-messages"
               value="20"
               data-component="query">
    <br>
<p>Number of items per page (default: 50). Example: <code>20</code></p>
                    ...
                    <h2 id="messages-POSTapi-messages-send">Send a message</h2>

<p>
<small class="badge badge-darkred">requires authentication</small>
</p>

<p>Send a WhatsApp message to a recipient.</p>

<span id="example-requests-POSTapi-messages-send">
<blockquote>Example request:</blockquote>
...
<span id="example-responses-POSTapi-messages-send">
            <blockquote>
            <p>Example response (200):</p>
        </blockquote>
                <pre>
...
<span id="execution-results-POSTapi-messages-send" hidden>
    <blockquote>Received response<span
                id="execution-response-status-POSTapi-messages-send"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-POSTapi-messages-send"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-POSTapi-messages-send" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-POSTapi-messages-send">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-POSTapi-messages-send" data-method="POST"
      data-path="api/messages/send"
      data-authed="1"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('POSTapi-messages-send', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-POSTapi-messages-send"
                    onclick="tryItOut('POSTapi-messages-send');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-POSTapi-messages-send"
                    onclick="cancelTryOut('POSTapi-messages-send');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-POSTapi-messages-send"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-black">POST</small>
            <b><code>api/messages/send</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Content-Type</code></b>&nbsp;&nbsp;
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="POSTapi-messages-send"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="POSTapi-messages-send"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>integer</small>&nbsp;
 ...
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="device_id"                data-endpoint="POSTapi-messages-send"
               value="1"
               data-component="body">
    <br>
<p>The ID of the connected device to send from. Example: <code>1</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="to"                data-endpoint="POSTapi-messages-send"
               value="+628123456789"
               data-component="body">
    <br>
<p>The recipient phone number (international format). Example: <code>+628123456789</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="message"                data-endpoint="POSTapi-messages-send"
               value="Hello, this is a test message!"
               data-component="body">
    <br>
<p>The message text. Example: <code>Hello, this is a test message!</code></p>
        </div>
        </form>

                    <h2 id="messages-POSTapi-messages-send-bulk">Send bulk messages</h2>

<p>
<small class="badge badge-darkred">requires authentication</small>
</p>

<p>Send the same message to multiple recipients. Messages are queued and sent with delays to avoid being banned.</p>

<span id="example-requests-POSTapi-messages-send-bulk">
<blockquote>Example request:</blockquote>


<div class="bash-example">
    <pre><code class="language-bash">curl --request POST \
    "http://localhost/api/messages/send-bulk" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json" \
    --data "{
    \"device_id\": 1,
...
<span id="example-responses-POSTapi-messages-send-bulk">
            <blockquote>
...
<span id="execution-results-POSTapi-messages-send-bulk" hidden>
    <blockquote>Received response<span
                id="execution-response-status-POSTapi-messages-send-bulk"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-POSTapi-messages-send-bulk"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-POSTapi-messages-send-bulk" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-POSTapi-messages-send-bulk">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-POSTapi-messages-send-bulk" data-method="POST"
      data-path="api/messages/send-bulk"
      data-authed="1"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('POSTapi-messages-send-bulk', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-POSTapi-messages-send-bulk"
                    onclick="tryItOut('POSTapi-messages-send-bulk');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-POSTapi-messages-send-bulk"
                    onclick="cancelTryOut('POSTapi-messages-send-bulk');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-POSTapi-messages-send-bulk"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-black">POST</small>
            <b><code>api/messages/send-bulk</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Content-Type</code></b>&nbsp;&nbsp;
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="POSTapi-messages-send-bulk"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="POSTapi-messages-send-bulk"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>integer</small>&nbsp;
 ...
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="device_id"                data-endpoint="POSTapi-messages-send-bulk"
               value="1"
               data-component="body">
    <br>
<p>The ID of the connected device. Example: <code>1</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<small>string[]</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="recipients[0]"                data-endpoint="POSTapi-messages-send-bulk"
               data-component="body">
        <input type="text" style="display: none"
               name="recipients[1]"                data-endpoint="POSTapi-messages-send-bulk"
               data-component="body">
    <br>
<p>Array of phone numbers.</p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>message</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="message"                data-endpoint="POSTapi-messages-send-bulk"
               value="Hello everyone!"
               data-component="body">
    <br>
<p>The message text. Example: <code>Hello everyone!</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>delay_seconds</code></b>&nbsp;&nbsp;
<small>integer</small>&nbsp;
<i>optional</i> &nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="delay_seconds"                data-endpoint="POSTapi-messages-send-bulk"
               value="15"
               data-component="body">
    <br>
<p>Delay between messages (5-60 seconds, default: 10). Example: <code>15</code></p>
        </div>
        </form>

                    <h2 id="messages-GETapi-messages--id-">Get message status</h2>
...
<small>integer</small>&nbsp;
 ...
 &nbsp;
               ...
               data-component="url">
    <br>
<p>The message ID. Example: <code>1</code></p>
            </div>
                    </form>
